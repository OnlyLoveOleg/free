...
# -*- coding: utf-8 -*-
#
# This version, support ffpmeg, youtube-dl, yt-dlp, moviepy 2.0, videos without audio, automatic dependencies installation and multithreading (thx to https://github.com/Javi3rV).
#
